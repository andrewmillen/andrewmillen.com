  ...
  return (
    <header className="py-4 md:py-8 lg:py-12 xl:py-20 border-b border-neutral-200 dark:border-neutral-800">
      <div className="container">
        ...
        <p className="text-xl leading-normal lg:leading-normal mb-6 lg:mb-12 text-neutral-600 dark:text-neutral-400 max-w-3xl">
        ...
        <p
          className="text-xl leading-normal lg:leading-normal mb-6 lg:mb-12 font-semibold"
