export default function Introduction({ content }) {
  return (
    <header>
      <div className="container py-[8vw] 2xl:py-28">
        <h1 className="h1">{content.name}</h1>
        <p className="h1">{content.title}</p>

        <p className="text-base xs:text-lg leading-normal lg:leading-relaxed xl:text-xl mt-20 md:mt-32 lg:mt-40 xl:mt-52 mb-8 lg:mb-12 text-neutral-800 dark:text-neutral-200 max-w-xl lg:max-w-3xl">
          {content.summary}
        </p>
