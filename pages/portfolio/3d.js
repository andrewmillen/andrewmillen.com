...
export default function D3() {
  return (
    <div className="flex flex-col gap-16 sm:gap-24 xl:gap-32 border-b border-border py-12 lg:py-20 px-6 sm:px-12 2xl:px-0">
      <MoreWorkHeader title="3D" />

      <main>
        <div className="flex flex-col space-y-12 lg:space-y-24 items-center">
          <div className="flex flex-col gap-12 md:flex-row xl:gap-24 items-center justify-center">
            <Figure
              type="image"
            ...
            <Figure
              type="image"
              src="/portfolio-assets/3d-controller.jpg"
