      ...
      <div className="flex justify-center my-12 xl:my-24">
        <div className="relative">
          ...
          <ImageWithCaption
            ...
            width="1298"
            height="624"
            caption="500-layer photorealistic <a class='textLink' href='https://en.wikipedia.org/wiki/Vexel' target='blank'>vexel</a> illustration of a Ferrari F430"
          />
        </div>
      </div>
      ...
      <div className="flex flex-col space-y-12 md:flex-row md:space-y-0 md:space-x-12 xl:space-x-24">
        ...
        <div className="lg:w-1/2 flex flex-col items-center lg:items-start space-y-12 xl:space-y-24">
          ...
          <ImageWithCaption
            ...
            width="600"
            height="630"
            caption="Custom typeface inspired by playing card pips, including an <a class='textLink' href='https://andrewmillen.github.io/casino-type-specimen/' target='blank'>interactive specimen</a>"
          />
        </div>
      </div>
    </MoreWorkLayout>
