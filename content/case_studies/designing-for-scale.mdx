...
<div className="py-0 2xl:py-12 2xl:pb-24">
...
<Image src="/portfolio-assets/design-systems-1.png" alt="The atomic tokens that make up the Mariposa design system." width={1000} height={500} quality="100" />
</figure>
</div>
...
<div className="text-center">
<figure className="my-0! mx-auto max-w-[1000px]">
<Image src="/portfolio-assets/design-systems-2.png" alt="A view comparing the similar structure of the same component in Figma and React." width={1000} height={500} quality="100" />
<figcaption>
...
<div className="text-center">
<figure className="my-0! mx-auto max-w-[1000px]">
<Image src="/portfolio-assets/design-systems-3.jpg" alt="A screenshot of the employee dashboard built with Mariposa components." width={1000} height={700} quality="100" />
<figcaption>
