...
<Image src="/portfolio-assets/employee-dashboard-2.jpg" alt="A screenshot of the new employee dashboard." width={1000} height={500} quality="100" />
<figcaption>
...
<div className="text-center">
<figure className="my-0! mx-auto max-w-[1000px]">
<Image src="/portfolio-assets/employee-dashboard-3.jpg" alt="A screenshot of the new employee dashboard on mobile." width={1000} height={700} quality="100" />
<figcaption>
...
<div className="text-center">
<figure className="my-0! mx-auto max-w-[1000px]">
<Image src="/portfolio-assets/employee-dashboard-4.png" alt="A collage showing the design tokens that make up the new design system." width={1000} height={666} quality="100" />
</figure>
</div>
