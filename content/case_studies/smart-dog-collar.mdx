...
<div className="text-center">
<figure className="my-0! mx-auto max-w-[1000px]">
<Image src="/portfolio-assets/smart-collar-2.jpg" alt="A wireframe with two approaches to onboarding." width={800} height={600} quality="100" />
</figure>
</div>
...
<div className="text-center">
<figure className="my-0! mx-auto max-w-[1000px]">
<Image src="/portfolio-assets/smart-collar-3.jpg" alt="A wireframe with two approaches to onboarding." width={1000} height={750} quality="100" />
</figure>
</div>
