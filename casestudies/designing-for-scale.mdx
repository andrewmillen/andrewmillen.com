...
## Saddled with UX debt, accessibility failures, and a lack of a centralized front end framework, OfficeSpace was in dire need of a design system.
...
>
## From Figma to Code
Meanwhile, a new dev team had been formed to build the new front-end framework that our design system would utilize. With my background in front-end, I was able to help by writing acceptance criteria, reviewing each component, even pushing some code changes myself.

Crucially, I made sure that the components in Figma and their counterparts in code shared the same property structure, which meant that any engineer could look at a Figma file and configure the components it’s built from with ease.
